...
%% Frequency of stress
load analysis3_corr_spec spec_analysis
...
load compare_sediment_percentiles_to_stress_tseries
thresh = 20;
mc = obs_model_percentiles(:,thresh/10);
...
%1. Mid-shelf band (2,3,2)
%2. Off-shore band (1,1,1)
%3. Outer mid-shelf band (1,2,1) &
%4. Nearshore band (3,3,2) %
%5. West Mud Patch around Nantucket Shoals (1,3,2)*
%6. West Mud Patch around Nantucket Shoals (1,2,2)*
%7. Nantucket Shoals (3,3,3) %
%8.  Nearshore band (1,3,1) &
%9.  Mid-shelf band (2,3,1)
%10.  Bits (1,3,3)*
%11.  Bits (2,3,3)
%12.  Bits (2,2,2)
%13.  Bits (2,2,1)
%14.  Nantucket Shoals (3,2,3) %
%15.  Nantucket Shoals (3,2,2) %
%16.  Offshore bits (1,1,2)
%17.  Bay bits (1,2,3)
%18.  Bits (2,1,1)
%19.  Nantucket Shoals (3,1,1)
%20.  Nantucket Shoals (3,1,2)
%21.  Nantucket Shoals (3,1,3)
%22.  Bits(3,2,1)

outMatNew = NaN(size(outMat));
%Region 1: Low Stress, Moderate-High Disturbance, Occuring
%Moderately-Highly Frequently (1,2-3,2-3)
outMatNew(
%Region 2:  Low Stress, Moderate-High Disturbance, Occurring Infrequently
%(1,2-3,1)

%Region 3: High Stress, Moderate-High Disturbance, Occurring
%Moderately-Highly Frequently (3,2-3,2-3)
