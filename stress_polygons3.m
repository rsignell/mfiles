...
%1. Mid-shelf (2,3,3)
%2. Mid shelf 2 (2,2,3)
%3.  Western Mud patch, outer shelf (1,2,1)*
%4.  Mid-shelf, eastern mud patch (1,2,2)
%5.  Mid-shelf, western mud patch (1,2,3)
%6.  Outer shelf (1,1,1)*
%7.  Nearshore (3,2,3)
%8.  Nearshore (3,3,3)
%9.  Bays, south of Nantucket Shoals (1,1,3)
%10.  " " " " (2,1,3)
%11.  Nantucket Shoals (3,1,3)
%12.  Outer shelf (1,1,2)
%13.  Mid-shelf (1,3,3)
%14.  Mid-shelf (1,3,2)
%15.  Nantucket Shoals (3,1,2)
%16.  Mid-shelf (2,2,2)
%17.  Mid-shelf (2,3,2)
%18.  Bays (2,1,2)
%19.  Mid shelf (1,3,1)
%20.  Nantucket Shoals (3,1,1)
%21.  Nearshore (3,2,2)
%22.  Bays (2,1,1)*
%23.  Bits (3,3,2)

%Region 1:  Low-moderate Stress, Low Disturbance at any frequency
outMatNew(ismember(outMat,[count(ii(3),1) count(ii(6),1) ...
    count(ii(22),1)])) = 1;

%Regoin 2:  Moderate-high Stress, Moderate-high Disturbance, Tides
outMatNew(ismember(outMat(,[count(